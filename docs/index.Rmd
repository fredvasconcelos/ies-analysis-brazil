...
fviz_cluster(kmeans(cluster_regiao_sex, 3, nstart = 25), cluster_regiao_sex[,1:2], ellipse.type = "norm", 
             repel = T, ggtheme = ggthemes::theme_clean(), palette = c('#4477AA', '#CC6677', '#117733'),
...
fviz_cluster(kmeans(cluster_uf_sex, 5, nstart = 25), cluster_uf_sex, ellipse.type = "norm", 
             repel = T, ggtheme = ggthemes::theme_clean(), palette = c('#4477AA', '#CC6677', '#117733', '#DDCC77', '#AA4499'),
...
fviz_cluster(kmeans(cluster_regiao_ethnic, 3, nstart = 25), cluster_regiao_ethnic, ellipse.type = "norm", 
             repel = T, ggtheme = ggthemes::theme_clean(), palette = c('#4477AA', '#CC6677', '#117733'),
...
fviz_cluster(kmeans(cluster_uf_ethnic, 5, nstart = 25), cluster_uf_ethnic, ellipse.type = "norm", 
             repel = T, ggtheme = ggthemes::theme_clean(), palette = c('#4477AA', '#CC6677', '#117733', '#DDCC77', '#AA4499'),
