...
t %>%
  ...
  sjPlot::tab_model(show.ci = F, show.df = T, show.est = T, show.se = T, show.r2 = T, show.stat = T)
```
...
fviz_cluster(kmeans(cluster_uf_sex, 5, nstart = 25), cluster_uf_sex[,1:2], ellipse.type = "norm", 
             repel = T, ggtheme = ggthemes::theme_clean(), palette = c('#4477AA', '#CC6677', '#117733', '#DDCC77'))
